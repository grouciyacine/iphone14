import React,{useRef,useSate,useCallback,forwardRef,useImperativeHandle, useEffect, useState} from 'react'
import {
    ViewerApp,
    AssetManagerPlugin,
    GBufferPlugin,
...
const WebgiViewer=forwardRef((props,ref)=>{
    {
        ...
        const  setupViewer= useCallback(async ()=>{
            ...
            await viewer.addPlugin(new TonemapPlugin(true)) //for width-fit height-fit
